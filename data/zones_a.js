...
starter:"total = 25 / 3\n# etiquette = f\"...\"\n",
test:"assert 'etiquette' in dir(), \"Crée une variable etiquette.\"\nassert '8.33' in etiquette and 'baies' in etiquette, \"Utilise {total:.2f} dans une f-string : on doit lire 8.33 baies (arrondi à 2 décimales).\"",
...
{q:"Que produit f\"{3.14159:.2f}\" ?", opts:["3.14","3.1415","3.142"], a:0}
],
boss: {t:"La borne d'accueil", p:"On te donne nom = \"pixel\" et annee = \"2024\" (deux chaînes). Construis une f-string accueil qui affiche EXACTEMENT :\nPIXEL, membre depuis 2024 (2 ans)\n\n• le nom en MAJUSCULES avec .upper()\n• l'année recopiée telle quelle\n• la durée entre parenthèses = 2026 - int(annee), soit 2 ans.",
starter:"nom = \"pixel\"\nannee = \"2024\"\n# accueil = ...\n",
